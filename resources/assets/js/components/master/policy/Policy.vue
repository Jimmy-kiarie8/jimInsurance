            ...
            <v-layout justify-center align-center>
                <div> 
                   <v-card>
                    ...
                    <v-card-title>
                        Policies
                        <!-- <download-excel :data="AllPolicies" :fields="json_fields">
                            Export
                            <img src="/storage/csv.png" style="width: 30px; height: 30px; cursor: pointer;">
                        </download-excel> -->
                            <v-btn slot="activator" color="primary" dark flat @click="openAdd">Add Policy</v-btn>
                            <v-tooltip right>
                                <v-btn icon slot="activator" class="mx-0" @click="getPolicies">
                    ...
                    <v-data-table :headers="headers" :items="AllPolicies" class="elevation-1" :loading="loading" :search="search">
...
export default {
  ...
  methods: {
    ...
    openAdd() {
      // alert('test')
      eventBus.$emit("openaddPolicyEvent");
      // this.dispAdd = true;
      // this.getCountry();
    },
    openEdit(item) {
      eventBus.$emit("openEditPolicyEvent", item);
    },
    showAlert() {
