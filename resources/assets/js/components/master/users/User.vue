...
<div>
    ...
    <AddUser @closeRequest="close" :openAddRequest="dispAdd" @alertRequest="showAlert" :allCompanies="allCompanies" :AllRoles="AllRoles"></AddUser>
    <EditUser @closeRequest="close" :openEditRequest="dispEdit" @alertRequest="showAlert" :form="editedItem" :allCompanies="allCompanies" :AllRoles="AllRoles"></EditUser>
